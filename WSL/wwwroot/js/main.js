...
require(['knockout', 'jquery', 'jqcloud'], function (ko, $) {
    ko.bindingHandlers.cloud = {
        init: function (element, valueAccessor, allBindings, viewModel, bindingContext) {
            // Hvad der f�rst sker n�r 'cloud' binding benyttes. Word subscriber p� en opdateringsfunktion der st�r nedenfor.
        ...
        // opdateringsfunktionen, der unwrapper observable arrayet words, s� JQCloud kan l�se dataen.
...
// templates hvor b�de hmtl og js filer er wrapped i komponenter. Registreret genne ko.components s� ko kan genkende dem per navnene. 
...
require(["knockout", "jquery", "broadcaster", "jqcloud", "bootstrap"], function (ko, jQuery, broadcaster, bootstrap) {
    (function () {
        ...
        var vm = (function () {
            ...
            // gem states fra de undersider, der har pagination og variabler som s�gefraser, der skal gemmes til n�ste bes�g af undersiden.
